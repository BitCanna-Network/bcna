...
1. Install `jq` and download the script:
    ...
    ```
    sudo apt install jq
    wget https://raw.githubusercontent.com/BitCanna-Network/cosmos-statesync_client/main/statesync_client_linux_new.sh
...
https://github.com/BitCanna-Network/bcna/blob/main/README.md#3Create-a-validator
...
1. Install `jq` and download the script:
    ...
    ```
    sudo apt install jq
    wget https://raw.githubusercontent.com/BitCanna-Network/cosmos-statesync_client/main/statesync_client_linux_existing.sh
