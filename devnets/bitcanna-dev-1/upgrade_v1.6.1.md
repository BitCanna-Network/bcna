# Node operator instructions for "Vigorous-Grow-Fix"`v1.6.1` upgrade on `bitcanna-dev-1`
...
wget https://github.com/BitCanna-Network/bcna/releases/download/v1.6.1/bcna_linux_amd64.tar.gz
```
