...
When a new version of the `bcnad` binary is released and governance has approved for it to take place, instructions on how to implement the upgrade with Cosmovisor are [included on the releasepage on GitHub](https://github.com/BitCanna-Network/bcna/releases/tag/v4.0.2).
...
An example can be found [here](https://github.com/BitCanna-Network/bcna/releases/tag/v4.0.2)
