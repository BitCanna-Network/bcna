...
1. Download the latest version (v4.0.2) from Github:
    ```
    cd $HOME
    wget -nc https://github.com/BitCanna-Network/bcna/releases/download/v4.0.2/bcnad_linux_amd64.tar.gz
    ```
...
7. You now have two options:
    ...
    * Or compile and install the binary in the $GOPATH path:  
        ...
        make install
        ```
Next step: [Syncing the chain](https://github.com/BitCanna-Network/bcna/blob/main/README.md#2-Sync-the-chain). 
